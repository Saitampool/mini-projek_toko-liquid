      ...
      <div className="container mx-auto">
        <div className="flex justify-between items-center" id="container">
          <a
            ...
            className="cursor-pointer text-white text-xl md:text-2xl font-bold"
          >
            <img src={logo} alt="logo" className="float-left pr-3" width={40} />{" "}
            Mas Liquid
          </a>
          <div className="space-x-5 hidden md:block md:w-auto">
            <a
              className="cursor-pointer text-[#F0F5F9] hover:text-blue-500 p-1 rounded-lg"
              onClick={() => {
                navigate("/");
                window.scrollTo(0, 0);
              }}
            ...
            <a
              className="text-[#F0F5F9] cursor-pointer hover:text-blue-500 p-1 rounded-lg"
              onClick={() => {
                navigate("/about");
                window.scrollTo(0, 0);
              }}
          ...
          <div className="flex items-center">
            <a
              className="cursor-pointer text-[#F0F5F9] flex items-center mr-4 hover:text-blue-500"
              onClick={() => {
                navigate("/cart");
              }}
            >
            ...
            <button
              ...
              type="button"
              className="inline-flex ml-2 items-center p-1 w-10 h-10 justify-center text-sm hover:text-blue-500 text-gray-200 rounded-lg md:hidden dark:text-gray-400"
