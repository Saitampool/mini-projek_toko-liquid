    ...
    <>
        ...
        <div className='text-white mt-3 md:mt-0 sm:pr-0 md:pr-3 md:pl-8 text-center md:text-left'>
          ...
          <ul className="list-none">
            ...
            className='list-none'><a className='text-white text-sm cursor-pointer hover:text-blue-400'>Beranda</a></li>
            <li 
            ...
            className='list-none'><a className='text-white text-sm cursor-pointer hover:text-blue-400'>Tentang Kami</a></li>
            <li 
